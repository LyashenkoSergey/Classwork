...
Module {
    ...
    property stringList config: ["shared","release","no_plugin_manifest"]
    property stringList qtConfig: ["shared","debug_and_release","debug","release","build_all","c++11","concurrent","dbus","no-pkg-config","stl"]
    property path binPath: "C:/Qt/Qt5.12.12/5.12.12/msvc2015_64/bin"
    property path installPath: "C:/Qt/Qt5.12.12/5.12.12/msvc2015_64/bin"
    property path incPath: "C:/Qt/Qt5.12.12/5.12.12/msvc2015_64/include"
    property path libPath: "C:/Qt/Qt5.12.12/5.12.12/msvc2015_64/lib"
    property path libExecPath: undefined
    property path qmlLibExecPath: "C:/Qt/Qt5.12.12/5.12.12/msvc2015_64/bin"
    property path pluginPath: "C:/Qt/Qt5.12.12/5.12.12/msvc2015_64/plugins"
    property string mkspecName: "win32-msvc"
    property path mkspecPath: "C:/Qt/Qt5.12.12/5.12.12/msvc2015_64/mkspecs/win32-msvc"
    ...
    property path docPath: "C:/Qt/Qt5.12.12/Docs/Qt-5.12.12"
    ...
    property string libFilePathDebug: "C:/Qt/Qt5.12.12/5.12.12/msvc2015_64/lib/Qt5Cored.lib"
    property string libFilePathRelease: "C:/Qt/Qt5.12.12/5.12.12/msvc2015_64/lib/Qt5Core.lib"
    ...
    cpp.includePaths: {
        var paths = ["C:/Qt/Qt5.12.12/5.12.12/msvc2015_64/include","C:/Qt/Qt5.12.12/5.12.12/msvc2015_64/include/QtCore"];
    ...
    cpp.staticLibraries: {
        ...
        if (qbs.targetOS.contains('windows') && !product.consoleApplication) {
            libs = libs.concat(qtBuildVariant === "debug"
                               ? ["Shell32.lib","C:/Qt/Qt5.12.12/5.12.12/msvc2015_64/lib/qtmaind.lib"] : ["Shell32.lib","C:/Qt/Qt5.12.12/5.12.12/msvc2015_64/lib/qtmain.lib"]);
        }
