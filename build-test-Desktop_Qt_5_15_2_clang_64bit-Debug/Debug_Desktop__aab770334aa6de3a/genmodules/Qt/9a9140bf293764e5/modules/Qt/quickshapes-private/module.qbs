...
QtModule {
    ...
    linkerFlagsRelease: []
    frameworksDebug: []
    frameworksRelease: ["QtQuick","QtQmlModels","QtQml","QtGui","AppKit","Metal","QtNetwork","QtCore","DiskArbitration","IOKit"]
    frameworkPathsDebug: []
