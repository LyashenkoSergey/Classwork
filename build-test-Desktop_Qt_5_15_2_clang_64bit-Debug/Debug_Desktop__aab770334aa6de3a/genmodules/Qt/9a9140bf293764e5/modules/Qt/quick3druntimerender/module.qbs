...
QtModule {
    ...
    Depends { name: "Qt"; submodules: ["core","gui","quick3drender","quick3dassetimport","quick3dutils"]}
    ...
    linkerFlagsRelease: []
    frameworksDebug: []
    frameworksRelease: ["QtQuick3DAssetImport","QtQuick3DRender","QtQuick3DUtils","QtQuick","QtGui","AppKit","Metal","QtQmlModels","QtQml","QtNetwork","QtCore","DiskArbitration","IOKit"]
    frameworkPathsDebug: []
    ...
    libFilePathRelease: "/Users/sergey/Qt/5.15.2/clang_64/lib/QtQuick3DRuntimeRender.framework/QtQuick3DRuntimeRender"
    pluginTypes: []
    ...
    cpp.systemIncludePaths: ["/Users/sergey/Qt/5.15.2/clang_64/lib/QtQuick3DRuntimeRender.framework/Headers"]
    cpp.libraryPaths: []
