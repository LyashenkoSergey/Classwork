...
QtModule {
    ...
    linkerFlagsRelease: []
    frameworksDebug: []
    frameworksRelease: ["QtTest","Security","Foundation","ApplicationServices","QtWidgets","QtGui","AppKit","Metal","QtCore","DiskArbitration","IOKit"]
    frameworkPathsDebug: []
