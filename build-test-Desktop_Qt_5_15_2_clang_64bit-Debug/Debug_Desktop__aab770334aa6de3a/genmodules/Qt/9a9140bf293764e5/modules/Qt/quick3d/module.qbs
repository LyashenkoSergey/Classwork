...
QtModule {
    ...
    linkerFlagsRelease: []
    frameworksDebug: []
    frameworksRelease: ["QtQuick3DRuntimeRender","QtQuick3DAssetImport","QtQuick3DRender","QtQuick3DUtils","QtQuick","QtGui","AppKit","Metal","QtQmlModels","QtQml","QtNetwork","QtCore","DiskArbitration","IOKit"]
    frameworkPathsDebug: []
    ...
    libFilePathRelease: "/Users/sergey/Qt/5.15.2/clang_64/lib/QtQuick3D.framework/QtQuick3D"
    pluginTypes: []
    ...
    cpp.systemIncludePaths: ["/Users/sergey/Qt/5.15.2/clang_64/lib/QtQuick3D.framework/Headers"]
    cpp.libraryPaths: []
