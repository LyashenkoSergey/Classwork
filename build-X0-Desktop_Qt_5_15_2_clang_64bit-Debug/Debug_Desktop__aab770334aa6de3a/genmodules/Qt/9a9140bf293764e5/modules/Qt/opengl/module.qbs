...
QtModule {
    ...
    linkerFlagsRelease: []
    frameworksDebug: []
    frameworksRelease: ["QtWidgets","QtGui","AppKit","Metal","QtCore","DiskArbitration","IOKit"]
    frameworkPathsDebug: []
