...
QtModule {
    ...
    Depends { name: "Qt"; submodules: ["core","gui","quick3dutils","quick"]}
    ...
    linkerFlagsRelease: []
    frameworksDebug: []
    frameworksRelease: ["QtQuick3DUtils","QtQuick","QtGui","AppKit","Metal","QtQmlModels","QtQml","QtNetwork","QtCore","DiskArbitration","IOKit"]
    frameworkPathsDebug: []
