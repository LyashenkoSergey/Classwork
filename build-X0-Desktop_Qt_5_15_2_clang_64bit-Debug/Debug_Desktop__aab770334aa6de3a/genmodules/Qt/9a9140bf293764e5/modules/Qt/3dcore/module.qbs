...
QtModule {
    ...
    linkerFlagsRelease: []
    frameworksDebug: []
    frameworksRelease: ["QtGui","AppKit","Metal","QtNetwork","QtCore","DiskArbitration","IOKit"]
    frameworkPathsDebug: []
