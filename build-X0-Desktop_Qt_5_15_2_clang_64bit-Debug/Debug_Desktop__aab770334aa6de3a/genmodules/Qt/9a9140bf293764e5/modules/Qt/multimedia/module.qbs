...
QtModule {
    ...
    linkerFlagsRelease: []
    frameworksDebug: []
    frameworksRelease: ["QtNetwork","QtGui","AppKit","Metal","QtCore","DiskArbitration","IOKit"]
    frameworkPathsDebug: []
