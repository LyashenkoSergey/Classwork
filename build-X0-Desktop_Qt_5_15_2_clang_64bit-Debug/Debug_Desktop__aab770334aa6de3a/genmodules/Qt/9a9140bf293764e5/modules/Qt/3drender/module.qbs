...
QtModule {
    ...
    linkerFlagsRelease: []
    frameworksDebug: []
    frameworksRelease: ["Qt3DCore","QtGui","AppKit","Metal","QtNetwork","QtCore","DiskArbitration","IOKit"]
    frameworkPathsDebug: []
