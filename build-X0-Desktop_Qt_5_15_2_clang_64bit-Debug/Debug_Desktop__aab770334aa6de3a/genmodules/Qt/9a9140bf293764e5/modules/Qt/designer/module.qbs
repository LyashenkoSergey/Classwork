...
QtModule {
    ...
    linkerFlagsRelease: []
    frameworksDebug: []
    frameworksRelease: ["QtWidgets","QtGui","AppKit","Metal","QtXml","QtCore","DiskArbitration","IOKit"]
    frameworkPathsDebug: []
