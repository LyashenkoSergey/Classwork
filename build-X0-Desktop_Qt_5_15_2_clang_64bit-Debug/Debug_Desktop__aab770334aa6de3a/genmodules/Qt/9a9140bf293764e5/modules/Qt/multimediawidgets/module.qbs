...
QtModule {
    ...
    linkerFlagsRelease: []
    frameworksDebug: []
    frameworksRelease: ["QtMultimedia","QtWidgets","QtGui","AppKit","Metal","QtNetwork","QtCore","DiskArbitration","IOKit"]
    frameworkPathsDebug: []
